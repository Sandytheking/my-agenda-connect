...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-white px-6 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Sección de pasos con animación */}
        <section className="mb-20 animate-fade-in delay-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pasos.map((paso, index) => (
              <div
                key={index}
                className="bg-[#000000] p-6 rounded-xl shadow-md flex flex-col items-center text-center transition duration-500 hover:scale-105 animate-slide-up"
              >
                <Image
                  src={paso.imagen}
                  alt={paso.titulo}
        ...
        {/* Beneficios */}
        <section className="bg-[#000000] p-8 rounded-xl shadow-md mb-16 animate-fade-in delay-300">
        ...
        {/* Acciones */}
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center mb-16 animate-fade-in delay-500">
          <Link
            href="/registro"
        ...
        {/* Footer */}
        <footer className="text-center text-sm text-white/50 mt-12 animate-fade-in delay-1000">

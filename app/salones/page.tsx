...
export default function SalonesLanding() {
  ...
  >
            ...
            >
              <Link
                href="/precios"
                className="group inline-flex items-center justify-center gap-3 bg-gradient-to-r from-pink-600 via-pink-500 to-purple-600 px-8 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl hover:from-pink-700 hover:to-purple-700"
              >
                Probar gratis
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-2 text-white group-hover:text-pink-300 transition-colors">{pain.title}</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {features.map((feature, i) => (
              <motion.div
                ...
                className="group bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 text-center hover:bg-gradient-to-br from-pink-500/10 to-purple-500/10 transition-all duration-300 cursor-pointer relative overflow-hidden"
              >
        ...
        <section className="max-w-6xl mx-auto mb-24 lg:mb-32">
          ...
          >
            Salones como el tuyo ya lo usan
          </motion.h2>
        ...
        <section className="max-w-4xl mx-auto text-center mb-20 py-16 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10">
          ...
          >
            <Link
              href="/precios"
              className="group inline-flex items-center justify-center gap-3 bg-gradient-to-r from-pink-600 via-pink-500 to-purple-600 px-12 py-5 rounded-2xl font-bold text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-pink-500/25"
            >
              Crear cuenta gratis
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
